...
class UIRegister:
    ...
    class PANEL:
        ...
        VIEW3D_POPOVER = lambda cls: UIRegister.PANEL.new(cls, 'VIEW_3D', 'UI', bl_options={"INSTANCED"})
        IMAGE_EDITOR_POPOVER = lambda cls: UIRegister.PANEL.new(cls, 'IMAGE_EDITOR', 'UI', bl_options={"INSTANCED"})
