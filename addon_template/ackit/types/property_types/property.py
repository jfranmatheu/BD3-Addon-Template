...
class PropertyTypes:
    ...
    COLOR_RGB = lambda default_color, **kwargs: FloatVectorProperty(default=default_color, min=0.0, max=1.0, size=3, **kwargs)
    COLOR_RGBA = lambda default_color, **kwargs: FloatVectorProperty(default=default_color, min=0.0, max=1.0, size=4, **kwargs)
